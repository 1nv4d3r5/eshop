...
//class eShop_Lang extends MX_Lang {

class eShop_Lang extends CI_Lang
{
	...
	{
		$browser_lang = !empty($_SERVER['HTTP_ACCEPT_LANGUAGE']) ? strtok(
			strip_tags($_SERVER['HTTP_ACCEPT_LANGUAGE']),
			','
		) : '';
	 ...
	 * modify your code
	 */
	public function load($langfile = '', $idiom = '', $return = FALSE, $add_suffix = TRUE, $alt_path = '', $load_first_lang = FALSE)
	{
		if ($load_first_lang)
		{
			reset($this->languages);
...
// END eShop_Lang Class

/* End of file eShop_Lang.php */
/* Location: ./application/core/eShop_Lang.php */